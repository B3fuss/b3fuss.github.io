...
%-------------------------------------------------------------------------------
\name{Bnaya Dreyfuss}{}
\position{Assistant Professor{\enskip\cdotp\enskip}Economics, University of Pittsburgh}
%\address{University, 100 University Dr, City, WA 11111}

%\mobile{+1 000-000-0000}
\email{bnaya3fuss@gmail.com}
\homepage{https://b3fuss.github.io/}
%\github{mygithub}
%\linkedin{mylinkedin}
% \gitlab{my-gitlab-id}
...
\makecvfooter
  {\the\month-\the\year}
  {Bnaya Dreyfuss ~~~·~~~ Curriculum Vitae}
  {\thepage}
